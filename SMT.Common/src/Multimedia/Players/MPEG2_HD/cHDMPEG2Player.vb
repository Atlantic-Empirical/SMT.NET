...
Namespace Multimedia.Players.HDMPEG2

    Public Class cHDMPEG2Player
...
#Region "cBasePlayer Overrides"
        ...
        Public Overrides Function BuildGraph(ByVal FilePath As String, ByVal NotifyWindowHandle As Integer, ByVal nAVMode As eAVMode, ByVal nParentForm As Form) As Boolean
            Try
                ...
                'If Not AddNVidiaVideoDecoder(Graph) Then Return False
                ...
                If AVMode <> eAVMode.DesktopVMR Then
                    ...
                    ''if using nv m2v dec
                    'HR = Graph.GraphBuilder.Connect(MCE_DMXA_Out, Me.VidDec_Vid_In)
                    'If HR < 0 Then Marshal.ThrowExceptionForHR(HR)

                    'HR = Graph.GraphBuilder.Connect(Me.VidDec_Vid_Out, KO_In)
                    'If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
                ...
                Else
                    ...
                    '    HR = Graph.GraphBuilder.Connect(Me.VidDec_Vid_Out, Me.VMR9_In_1)
                    '    If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
            ...
            Catch ex As Exception
                Throw New Exception("Problem with BuildVideoGraph HD M2V. Error: " & ex.Message & " StackTrace: " & ex.StackTrace, ex)
                Return False
            End Try
        End Function
        ...
        Public Overrides Function FilterCheck() As String
            Try
                ...
                If Not MainConcept_MPEGDecoder Then msgstr &= "MainConcept MPEG-2 Decoder" & vbNewLine
