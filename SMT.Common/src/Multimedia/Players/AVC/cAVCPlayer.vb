...
Namespace Multimedia.Players.AVC

    Public Class cAVCPlayer
        ...
        Public Overrides Function BuildGraph(ByVal FilePath As String, ByVal NotifyWindowHandle As Integer, ByVal nAVMode As eAVMode, ByVal nParentForm As Form) As Boolean
            Try
                ...
                If AVMode <> eAVMode.DesktopVMR Then
                    ...
                    'HR = Graph.Connect(KO_Out, MCE_CHG_In)
                    ...
                    HR = Graph.GraphBuilder.Connect(Graph.MCE_AVC_Out, Graph.KO_In)
                    If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
                ...
                Else
                    ...
                    'HR = Graph.GraphBuilder.Connect(MCE_AVC_Out, VMR9_In_1)
                    'If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
            ...
            Catch ex As Exception
                Throw New Exception("Problem with BuildVideoGraph AVC. Error: " & ex.Message & " Stack: " & ex.StackTrace, ex)
            End Try
        End Function
