...
Namespace Multimedia.Players.JacketPictures
    ...
    Public Class cJacketPicturePlayer_SD
...
#Region "cBasePlayer Overrides"
        ...
        Public Overrides Function BuildGraph(ByVal FilePath As String, ByVal NotifyWindowHandle As Integer, ByVal nAVMode As eAVMode, ByVal nParentForm As Form) As Boolean
            Try
                ...
                If Not Graph.AddNullVideoSource() Then Return False
            ...
            Catch ex As Exception
                Throw New Exception("Problem with BuildVideoGraph JacketPicturePlayer SD. Error: " & ex.Message & " Stack: " & ex.StackTrace)
                Return False
            End Try
        End Function
        ...
        Public Overrides Function FilterCheck() As String
            Try
                ...
                If Not SMT_KeystoneSD Then msgstr &= "SMT Keystone SD" & vbNewLine
