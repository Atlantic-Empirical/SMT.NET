...
Namespace Multimedia.Utility.Timecode
    ...
    Public Module mTimecode
        ...
        Public Function CompareDVDTimecodes(ByVal TC1 As DvdTimeCode, ByVal TC2 As DvdTimeCode) As Byte
            Try
                ...
                If TC1.bHours > TC2.bHours Then
                    Return 1
                ElseIf TC1.bHours < TC2.bHours Then
                    Return 2
                End If

                If TC1.bMinutes > TC2.bMinutes Then
                    Return 1
                ElseIf TC1.bMinutes < TC2.bMinutes Then
                    Return 2
                End If

                If TC1.bSeconds > TC2.bSeconds Then
                    Return 1
                ElseIf TC1.bSeconds < TC2.bSeconds Then
                    Return 2
                End If

                If TC1.bFrames > TC2.bFrames Then
                    Return 1
                ElseIf TC1.bFrames < TC2.bFrames Then
                    Return 2
                End If
            ...
            Catch ex As Exception
                Throw New Exception("CompareDVDTimecodes failed. Error: " & ex.Message)
            End Try
        End Function
        ...
        Public Function RT_to_PTS(ByVal REFERENCE_TIME As UInt64) As UInt64
            Return REFERENCE_TIME * (9 / 1000)
            'Return ((REFERENCE_TIME * 18) - 9) / 2000
        End Function

        Public Function PTS_to_RT(ByVal PTS As UInt64) As UInt64
            Return PTS * (1000 / 9)
            'Return ((PTS * 2000) + 9) / 18
        End Function
