...
Namespace Multimedia.Filters.SMT.Keystone
    ...
    Public Interface IKeystone_FS

        <PreserveSig()> _
        Function get_InputOneMediaType(ByRef InputMediaType As AM_MEDIA_TYPE) As Integer

        <PreserveSig()> _
        Function get_InputTwoMediaType(ByRef InputMediaType As AM_MEDIA_TYPE) As Integer
        ...
        <PreserveSig()> _
        Function ResendLastSamp() As Integer

        <PreserveSig()> _
        Function StartRecording( _
            <[In](), MarshalAs(UnmanagedType.LPWStr)> ByVal pszFileName As String) As Integer
