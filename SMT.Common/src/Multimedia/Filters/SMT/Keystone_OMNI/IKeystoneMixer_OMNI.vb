...
Namespace Multimedia.Filters.SMT.Keystone
    ...
    Public Interface IKeystoneMixer_OMNI
        ...
        <PreserveSig()> _
        Function BurnGOPTCs(ByVal iBurnGOPTCs As Short, ByVal iBlinkRed As Short) As Integer
        ...
        <PreserveSig()> _
        Function SetActionTitleSafeColor(ByVal Red As Integer, ByVal Green As Integer, ByVal Blue As Integer) As Integer

        <PreserveSig()> _
        Function BarDataConfig( _
            <[In]()> ByVal DetectBarData As Integer, _
            <[In]()> ByVal BurnGuides As Integer, _
            <[In]()> ByVal Luma_Tolerance As Integer, _
            <[In]()> ByVal Chroma_Tolerance As Integer) As Integer

        <PreserveSig()> _
        Function BarDataReset() As Integer
